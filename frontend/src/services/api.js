...
|
| IMPORTANT:
| There is NO DEFAULT_HOSPITAL here.
|
| The backend should decide whether hospitalId is required.
| The frontend does not manufacture a fake MongoDB ObjectId.
|
|--------------------------------------------------------------------------
*/
...
export const waste = {
  list: (params = {}) => {
    ...
    if (
      ...
      cleanParams.hospitalId === 'DEFAULT_HOSPITAL'
    ) {
